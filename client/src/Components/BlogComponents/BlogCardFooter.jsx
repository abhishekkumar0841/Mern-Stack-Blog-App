      ...
      <div  className=" text-2xl flex items-center gap-5 ">
        {!isLike ? (
          <div className=" h-14 w-14  rounded-full bg-gray-50 flex items-center justify-center">
            <FcLikePlaceholder onClick={fetchLike}
          ...
          <div className="  h-14 w-14 bg-gray-50  rounded-full flex items-center justify-center">
            <FcLike onClick={fetchRemoveLike} className=" text-3xl text-red-400 transition-all duration-300 ease-in-out hover:scale-125 cursor-pointer" />
          </div>
        )}
